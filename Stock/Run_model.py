...
train_loader, test_loader, all_t, all_i ,scaler= get_topo_dataloader(args, data_type,
...
#start training
trainer = Trainer(model, loss, optimizer, train_loader, train_loader, test_loader, scaler,
