...
class LeNet(nn.Module):
    def __init__(self, num_classes=10):
        ...
        #self.conv_2 = nn.Conv1d(in_channels=9, out_channels=9,stride = 1, kernel_size=5)
        #self.fc_1 = nn.Linear(16 * 2 * 2, 120)
        #self.fc_1 = nn.Linear(108, 32)
        #self.fc_1 = nn.Linear(180, 32)
        #self.fc_1 = nn.Linear(3528, 84)
        #self.bn1 = nn.BatchNorm1d(120)
        #self.fc_2 = nn.Linear(32, 84)
        ...
        #self.dropout2 = nn.Dropout(p=0.05)  # dropout训练
